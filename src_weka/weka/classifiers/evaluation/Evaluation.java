...
public class Evaluation implements Summarizable, RevisionHandler, Serializable {
  ...
  /**
   * Total cross validation elapsed time - mjh
   */
  protected long m_CVElapsed;
  ...
  /**
   * Sets the total cross validation elapsed time
   */
  public final void setCVElapsed(long elapsed) {
  	System.out.println("Evaluation setCVElapsed " + elapsed);
  	m_CVElapsed = elapsed;
  }
  
  /**
   * Return to total cross validation elapsed time
   *
   * @return total cv elapsed time
   */
  public final long cvElapsed() {
  	return m_CVElapsed;
  }
  ...
  public String getRevision() {
    return RevisionUtils.extract("$Revision: 15278 $");
  }
}
