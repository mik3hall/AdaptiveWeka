...
rm -r WekaAdaptiveCVI.app

${PACKAGER} \
	--verbose \
	--input input \
	--icon input/weka.ico \
	--name WekaAdaptiveCVI \
	--type "app-image" \
	--main-jar weka.jar \
	--main-class weka.gui.GUIChooser \
	--module-path '/Users/mjh/Documents/javafx-jmods-21.0.1' \
	--java-options '-Xmx12g -XX:+UnlockDiagnosticVMOptions --add-opens java.desktop/javax.swing.text=ALL-UNNAMED --enable-native-access=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED --add-exports java.base/java.lang=ALL-UNNAMED -Djava.security.manager=allow -DAEVD=true -DACVI=true' \
