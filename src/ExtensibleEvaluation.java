 ...
 */
public class ExtensibleEvaluation implements Summarizable, RevisionHandler, Serializable {
   ...
   */
  public ExtensibleEvaluation(Instances data) throws Exception {
   ...
   * @see #setPriors(Instances)
   */
  public ExtensibleEvaluation(Instances data, CostMatrix costMatrix) throws Exception {
